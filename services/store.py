...
search_profiles = []
candidate_matches = []
# Reapariciones de personas de un evento en otras cámaras del equipo (seguimiento).
track_sightings = []
users = seed_users()
...
logs = [AuditLog('2026-09-23 10:25:41','Sistema','Coincidencia','Posible coincidencia detectada', 'BUS-2026-0184','CAM-008','Pendiente de validación'),
        AuditLog('2026-09-23 10:23:02','Sistema','Coincidencia','Posible coincidencia detectada', 'BUS-2026-0184','CAM-007'),
        AuditLog('2026-09-23 10:21:14','Sistema','Coincidencia','Posible coincidencia detectada', 'BUS-2026-0184','CAM-004'),
        ...
        AuditLog('2026-09-23 09:31:54','Operador02','Revisión','Descartó coincidencia','BUS-2026-0185','CAM-014','Descartada')]
