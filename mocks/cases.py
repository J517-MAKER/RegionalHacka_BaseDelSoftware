...
def seed_cases():
    names = ['Elena Robles (ficticia)', 'Mateo Silva (ficticio)', 'Lucía Vega (ficticia)', 'Daniel Ríos (ficticio)', 'Carlos Rodriguez']
    locations = ['Plaza de la República', 'Estación Alameda', 'Mercado del Centro', 'Parque Norte', 'Plaza de la Constitución']
    return [SearchCase(
        ...
        location=locations[i], zone=['Centro', 'Centro', 'Poniente', 'Norte', 'Centro'][i],
